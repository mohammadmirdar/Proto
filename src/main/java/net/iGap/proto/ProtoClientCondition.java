...
public final class ProtoClientCondition {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface RoomOrBuilder extends
       ...
       * @deprecated proto.ClientCondition.Room.offline_deleted_deprecated is deprecated.
       *     See ClientCondition.proto;l=17
      ...
      /**
       * <code>.proto.ClientCondition.Room.OfflineMute offline_mute = 12;</code>
    ...
    private static final long serialVersionUID = 0L;
      ...
      public interface OfflineEditedOrBuilder extends
        ...
        /**
         * <code>.proto.Mention mentions = 4;</code>
        ...
        /**
         * <code>.proto.TextSigns text_signs = 5;</code>
      ...
      private static final long serialVersionUID = 0L;
        ...
        public static final class Builder extends
          ...
          private void buildPartial0(net.iGap.proto.ProtoClientCondition.ClientCondition.Room.OfflineEdited result) {
      ...
      private static final long serialVersionUID = 0L;
        ...
        public static final class Builder extends
          ...
          private void buildPartial0(net.iGap.proto.ProtoClientCondition.ClientCondition.Room.OfflineDeleted result) {
            int from_bitField0_ = bitField0_;
            if (((from_bitField0_ & 0x00000001) != 0)) {
              result.messageId_ = messageId_;
            }
      ...
      public static final class Builder extends
        ...
        private void buildPartialRepeatedFields(net.iGap.proto.ProtoClientCondition.ClientCondition.Room result) {
          if (offlineEditedBuilder_ == null) {
        ...
        private void buildPartial0(net.iGap.proto.ProtoClientCondition.ClientCondition.Room result) {
          int from_bitField0_ = bitField0_;
          if (((from_bitField0_ & 0x00000001) != 0)) {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 48: {
                  ...
                  ensureOfflineDeletedDeprecatedIsMutable();
                  offlineDeletedDeprecated_.addLong(v);
                  break;
                } // case 48
                case 50: {
                ...
                case 58: {
                  net.iGap.proto.ProtoClientCondition.ClientCondition.Room.OfflineEdited m =
                      input.readMessage(
                          net.iGap.proto.ProtoClientCondition.ClientCondition.Room.OfflineEdited.parser(),
                          extensionRegistry);
                  if (offlineEditedBuilder_ == null) {
                    ensureOfflineEditedIsMutable();
                    offlineEdited_.add(m);
                  } else {
                    offlineEditedBuilder_.addMessage(m);
                  }
                  break;
                } // case 58
                case 64: {
                ...
                case 114: {
                  net.iGap.proto.ProtoClientCondition.ClientCondition.Room.OfflineDeleted m =
                      input.readMessage(
                          net.iGap.proto.ProtoClientCondition.ClientCondition.Room.OfflineDeleted.parser(),
                          extensionRegistry);
                  if (offlineDeletedBuilder_ == null) {
                    ensureOfflineDeletedIsMutable();
                    offlineDeleted_.add(m);
                  } else {
                    offlineDeletedBuilder_.addMessage(m);
                  }
                  break;
                } // case 114
                default: {
        ...
        private void ensureOfflineDeletedDeprecatedIsMutable() {
          if (!offlineDeletedDeprecated_.isModifiable()) {
            offlineDeletedDeprecated_ = makeMutableCopy(offlineDeletedDeprecated_);
          }
          bitField0_ |= 0x00000010;
        }
        /**
        ...
        private void ensureOfflineSeenIsMutable() {
          if (!offlineSeen_.isModifiable()) {
            offlineSeen_ = makeMutableCopy(offlineSeen_);
          }
          bitField0_ |= 0x00000040;
        }
        /**
        ...
        private void ensureOfflineListenedIsMutable() {
          if (!offlineListened_.isModifiable()) {
            offlineListened_ = makeMutableCopy(offlineListened_);
          }
          bitField0_ |= 0x00000800;
        }
        /**
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(net.iGap.proto.ProtoClientCondition.ClientCondition result) {
        if (roomsBuilder_ == null) {
          if (((bitField0_ & 0x00000002) != 0)) {
      ...
      private void buildPartial0(net.iGap.proto.ProtoClientCondition.ClientCondition result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                net.iGap.proto.ProtoClientCondition.ClientCondition.Room m =
                    input.readMessage(
                        net.iGap.proto.ProtoClientCondition.ClientCondition.Room.parser(),
                        extensionRegistry);
                if (roomsBuilder_ == null) {
                  ensureRoomsIsMutable();
                  rooms_.add(m);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(net.iGap.proto.ProtoClientCondition.ClientConditionResponse result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "proto\032\016Response.proto\032\014Global.proto\"\263\006\n\017" +
      "ClientCondition\022\037\n\007request\030\001 \001(\0132\016.proto" +
      ".Request\022*\n\005rooms\030\002 \003(\0132\033.proto.ClientCo" +
      "ndition.Room\032\322\005\n\004Room\022\017\n\007room_id\030\002 \001(\004\022\027" +
      ...
      "ne_edited\030\007 \003(\0132).proto.ClientCondition." +
      ...
      "\030\014 \001(\0162\'.proto.ClientCondition.Room.Offl" +
      "ineMute\022\030\n\020offline_listened\030\r \003(\004\022C\n\017off" +
      "line_deleted\030\016 \003(\0132*.proto.ClientConditi" +
      "on.Room.OfflineDeleted\032\221\001\n\rOfflineEdited" +
      "\022\022\n\nmessage_id\030\001 \001(\004\022\017\n\007message\030\002 \001(\t\022\023\n" +
      "\013document_id\030\003 \001(\004\022 \n\010mentions\030\004 \001(\0132\016.p" +
      "roto.Mention\022$\n\ntext_signs\030\005 \001(\0132\020.proto" +
      ...
      "ED\020\001\022\013\n\007UNMUTED\020\002\"<\n\027ClientConditionResp" +
      "onse\022!\n\010response\030\001 \001(\0132\017.proto.ResponseB" +
      "&\n\016net.iGap.protoB\024ProtoClientConditionb" +
      "\006proto3"
    };
    ...
    internal_static_proto_ClientCondition_Room_OfflineEdited_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_proto_ClientCondition_Room_OfflineEdited_descriptor,
        new java.lang.String[] { "MessageId", "Message", "DocumentId", "Mentions", "TextSigns", });
    internal_static_proto_ClientCondition_Room_OfflineDeleted_descriptor =
