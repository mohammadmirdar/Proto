...
public final class ProtoUserGetDeleteToken {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(net.iGap.proto.ProtoUserGetDeleteToken.UserGetDeleteToken result) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(tokenRegex_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 4, tokenRegex_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(tokenLength_)) {
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(net.iGap.proto.ProtoUserGetDeleteToken.UserGetDeleteTokenResponse result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                tokenRegex_ = input.readStringRequireUtf8();
                bitField0_ |= 0x00000008;
                break;
              } // case 34
              case 42: {
                tokenLength_ = input.readStringRequireUtf8();
                bitField0_ |= 0x00000010;
                break;
              } // case 42
              default: {
      ...
      private void ensureSmsNumberIsMutable() {
        if (!smsNumber_.isModifiable()) {
          smsNumber_ = makeMutableCopy(smsNumber_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
