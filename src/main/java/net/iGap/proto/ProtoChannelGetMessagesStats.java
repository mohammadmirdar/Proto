...
public final class ProtoChannelGetMessagesStats {
  ...
  public interface ChannelGetMessagesStatsOrBuilder extends
     ...
     * @deprecated proto.ChannelGetMessagesStats.message_id is deprecated.
     *     See ChannelGetMessagesStats.proto;l=11
  ...
  private static final long serialVersionUID = 0L;
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final class Builder extends
        ...
        private void buildPartial0(net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStats.messageIdInfo result) {
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStats result) {
        if (messageIdInfoBuilder_ == null) {
      ...
      private void buildPartial0(net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStats result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStats.messageIdInfo m =
                    input.readMessage(
                        net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStats.messageIdInfo.parser(),
                        extensionRegistry);
                if (messageIdInfoBuilder_ == null) {
                  ensureMessageIdInfoIsMutable();
                  messageIdInfo_.add(m);
                } else {
                  messageIdInfoBuilder_.addMessage(m);
                }
                break;
              } // case 34
              default: {
      ...
      private void ensureMessageIdIsMutable() {
        if (!messageId_.isModifiable()) {
          messageId_ = makeMutableCopy(messageId_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private static final long serialVersionUID = 0L;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(viewsLabel_)) {
          com.google.protobuf.GeneratedMessageV3.writeString(output, 2, viewsLabel_);
        }
        if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(thumbsUpLabel_)) {
          com.google.protobuf.GeneratedMessageV3.writeString(output, 3, thumbsUpLabel_);
        }
        if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(thumbsDownLabel_)) {
      ...
      public static final class Builder extends
        ...
        private void buildPartial0(net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStatsResponse.Stats result) {
          int from_bitField0_ = bitField0_;
          if (((from_bitField0_ & 0x00000001) != 0)) {
            result.messageId_ = messageId_;
          }
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 18: {
                  viewsLabel_ = input.readStringRequireUtf8();
                  bitField0_ |= 0x00000002;
                  break;
                } // case 18
                case 26: {
                  thumbsUpLabel_ = input.readStringRequireUtf8();
                  bitField0_ |= 0x00000004;
                  break;
                } // case 26
                case 34: {
                  thumbsDownLabel_ = input.readStringRequireUtf8();
                  bitField0_ |= 0x00000008;
                  break;
                } // case 34
                case 40: {
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStatsResponse result) {
        if (statsBuilder_ == null) {
      ...
      private void buildPartial0(net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStatsResponse result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStatsResponse.Stats m =
                    input.readMessage(
                        net.iGap.proto.ProtoChannelGetMessagesStats.ChannelGetMessagesStatsResponse.Stats.parser(),
                        extensionRegistry);
                if (statsBuilder_ == null) {
                  ensureStatsIsMutable();
                  stats_.add(m);
